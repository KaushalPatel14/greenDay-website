...
const GreenDaySpaSection = ({ GreenDaySpaData }) => {
    ...
    return (
        <div className='relative z-10 py-[80px] md:py-[140px] lg:py-[152px] overflow-hidden' style={{ backgroundImage: `url(${bgImage})`, backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "cover",backgroundAttachment:"fixed" }} >
