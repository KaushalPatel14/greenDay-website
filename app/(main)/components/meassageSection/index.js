...
//     console.log(meassageSectionData,"lm")
//     return (
//         <div
//             className={clsx(
//                 "relative z-10",
...
//                 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-6 em:gap-y-12 gap-4"   >
...
//                                             width={400}
//                                             height={400}
//                                             className="object-contain h-[180px] md:h-auto"
//                                         />
//                                     </div>
...
//                                             {title}
//                                         </h5>
//                                         <p className="text-sm md:text-base text-center font-OpenSans tracking-[0.65px]">
//                                             {description}
//                                         </p>
...
// const MeassageSection = ({ meassageSectionData, animate }) => {
//     const { image, meassageSection } = meassageSectionData || {};  
//     console.log(meassageSection, "lm");  // Debugging
...
//             <div className="container py-28 em:py-32 px-4 sm:px-8 min-h-screen flex flex-col items-center justify-center">
//                 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-6 em:gap-y-12 gap-4">
//                     {meassageSection &&  // ✅ Fixed key name
//                         meassageSection.map((item, index) => {  // ✅ Fixed key name here
//                             const { title, description, button, variant, bgImage } = item || {};  // ✅ Fixed "varient" typo

//                             console.log(item, "about");  // Debugging
