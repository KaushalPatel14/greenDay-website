export const Banner = {
    ...
    title: "Shirodhara",
    images: "/images/ShirodharaBanner.png"
}
...
export const serviceDetails = {
    ...
    listItem: [
        ...
        { list: "In the western alternative medicine world, I personally do not know of another therapy the system apart, from an established meditation practice." },
        { list: "Includes : Shirodhara massage to back, legs, arms, abdomen, neck and shoulders" }
    ],
    button: "Reserve Now",
    imageAndvideo: [
        { item: "/images/serviceDetailsimage1.png" },
        { item: "/images/serviceDetailsimage2.png" },
        { item: "" },
    ]
}